...
:Network Node: eth0 (10.10.10.52), eth1 (10.10.20.52), eth2 (192.168.100.52)
:Compute Node: eth0 (10.10.10.53), eth1 (10.10.20.53), eth2 (192.168.100.53)
...
* Modify the /etc/nova/nova.conf like this::
   ...
   keystone_ec2_url=http://10.10.10.51:5000/v2.0/ec2tokens
   # Imaging service
...
* Create a new subnet inside the new tenant network::
   ...
   quantum subnet-create --tenant-id $put_id_of_project_one net_proj_one 172.16.1.0/24
...
* Add the following route on controller node only::
   ...
   route add -net 172.16.1.0/24 gw $router_proj_one_IP
